...
public class EmployeeH2Service implements EmployeeRepository {
    ...
    public Employee addEmployee(Employee employee) {
        db.update("insert into employeeList(employeeName, employeeId, email, department) values (?,?,?,?)",
                employee.getEmployeeName(), employee.getEmployeeId(), employee.getEmail(), employee.getDepartment());
